    ...
    <div style={{ background:'#f5f5f5', minHeight:'100vh', paddingBottom:70 }}>
      ...
      <div style={{ background:'#fff', borderBottom:'1px solid #f0f0f0' }}>
        ...
        <div style={{ position:'relative', background:'#f0f0f0' }}>
          ...
          {/* Tap to view */}
          {allPhotos.length > 0 && (
            <div style={{ position:'absolute', bottom:10, left:10, background:'rgba(0,0,0,0.5)', color:'#fff', padding:'4px 10px', borderRadius:12, fontSize:11, display:'flex', alignItems:'center', gap:4 }}>
