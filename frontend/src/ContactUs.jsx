  ...
  return (
    <div style={{ background:'#f5f5f5', minHeight:'100vh', paddingBottom:70 }}>
      ...
      <div style={{ background:'#fff', padding:'20px 16px', borderBottom:'1px solid #f0f0f0', textAlign:'center' }}>
        <h1 style={{ fontSize:20, fontWeight:700, color:'#222', margin:0 }}>Contact Us</h1>
        <p style={{ fontSize:13, color:'#999', marginTop:4 }}>We'd love to hear from you</p>
      </div>
      ...
      <div style={{ maxWidth:600, margin:'0 auto', padding:'12px' }}>
        ...
        <div style={{ display:'flex', flexDirection:'column', gap:10, marginBottom:12 }}>
          ...
          <a href="tel:+919025316833" style={{ display:'flex', alignItems:'center', gap:14, background:'#fff', borderRadius:12, padding:'16px 18px', border:'1px solid #f0f0f0', boxShadow:'0 1px 4px rgba(0,0,0,0.04)', textDecoration:'none' }}>
            ...
            <div>
              <div style={{ fontSize:11, fontWeight:700, color:'#999', textTransform:'uppercase', letterSpacing:0.5 }}>Phone</div>
              <div style={{ fontSize:16, fontWeight:700, color:'#16a34a' }}>+91 90253 16833</div>
            </div>
          </a>
          ...
          <a href="https://wa.me/919025316833" target="_blank" rel="noopener noreferrer" style={{ display:'flex', alignItems:'center', gap:14, background:'#fff', borderRadius:12, padding:'16px 18px', border:'1px solid #f0f0f0', boxShadow:'0 1px 4px rgba(0,0,0,0.04)', textDecoration:'none' }}>
            ...
            <div>
              <div style={{ fontSize:11, fontWeight:700, color:'#999', textTransform:'uppercase', letterSpacing:0.5 }}>WhatsApp</div>
              <div style={{ fontSize:16, fontWeight:700, color:'#25D366' }}>+91 90253 16833</div>
            </div>
          </a>
          ...
          <a href="mailto:info@kumbakonamfreematrimony.com" style={{ display:'flex', alignItems:'center', gap:14, background:'#fff', borderRadius:12, padding:'16px 18px', border:'1px solid #f0f0f0', boxShadow:'0 1px 4px rgba(0,0,0,0.04)', textDecoration:'none' }}>
            ...
            <div>
              <div style={{ fontSize:11, fontWeight:700, color:'#999', textTransform:'uppercase', letterSpacing:0.5 }}>Email</div>
              <div style={{ fontSize:14, fontWeight:600, color:'#2563eb' }}>info@kumbakonamfreematrimony.com</div>
            </div>
          </a>
          ...
          <div style={{ display:'flex', alignItems:'flex-start', gap:14, background:'#fff', borderRadius:12, padding:'16px 18px', border:'1px solid #f0f0f0', boxShadow:'0 1px 4px rgba(0,0,0,0.04)' }}>
            ...
            <div>
              <div style={{ fontSize:11, fontWeight:700, color:'#999', textTransform:'uppercase', letterSpacing:0.5 }}>Office Address</div>
              <div style={{ fontSize:14, fontWeight:600, color:'#333', lineHeight:1.6 }}>
                No. 45, Big Street,<br/>
          ...
          <div style={{ display:'flex', alignItems:'center', gap:14, background:'#fff', borderRadius:12, padding:'16px 18px', border:'1px solid #f0f0f0', boxShadow:'0 1px 4px rgba(0,0,0,0.04)' }}>
            ...
            <div>
              <div style={{ fontSize:11, fontWeight:700, color:'#999', textTransform:'uppercase', letterSpacing:0.5 }}>Working Hours</div>
              <div style={{ fontSize:14, fontWeight:600, color:'#333' }}>Mon - Sat: 9:00 AM - 7:00 PM</div>
              <div style={{ fontSize:12, color:'#999' }}>Sunday: Closed</div>
            </div>
          </div>
        </div>
        ...
        <div style={{ background:'#fff', borderRadius:12, padding:'20px 18px', border:'1px solid #f0f0f0', boxShadow:'0 1px 4px rgba(0,0,0,0.04)' }}>
          <div style={{ fontSize:15, fontWeight:700, color:'#222', marginBottom:16 }}>Send us a Message</div>

          {user && (
            <div style={{ background:'#eff6ff', border:'1px solid #bfdbfe', borderRadius:8, padding:'10px 14px', marginBottom:14, fontSize:13, color:'#2563eb', fontWeight:500, display:'flex', alignItems:'center', gap:8 }}>
          ...
          {error && (
            <div style={{ background:'#fef2f2', border:'1px solid #fecaca', borderRadius:8, padding:'10px 14px', marginBottom:14, fontSize:13, color:'#dc2626', fontWeight:600 }}>
              {error}
            </div>
          )}
          ...
          <form onSubmit={handleSubmit}>
            <div style={{ marginBottom:12 }}>
              <label style={{ fontSize:11, fontWeight:700, color:'#888', textTransform:'uppercase', letterSpacing:0.5, display:'block', marginBottom:4 }}>Your Name</label>
            ...
            <div style={{ marginBottom:12 }}>
              <label style={{ fontSize:11, fontWeight:700, color:'#888', textTransform:'uppercase', letterSpacing:0.5, display:'block', marginBottom:4 }}>Phone Number</label>
              <input value={form.phone} onChange={e => setForm({...form, phone:e.target.value})} required
                placeholder="Enter your phone number" type="tel"
                readOnly={!!user}
                style={{ width:'100%', padding:'10px 12px', border:'1.5px solid #e0e0e0', borderRadius:8, fontSize:14, outline:'none', boxSizing:'border-box', background: user ? '#f9fafb' : '#fff' }} />
            </div>
            <div style={{ marginBottom:12 }}>
              <label style={{ fontSize:11, fontWeight:700, color:'#888', textTransform:'uppercase', letterSpacing:0.5, display:'block', marginBottom:4 }}>Email (Optional)</label>
              <input value={form.email} onChange={e => setForm({...form, email:e.target.value})}
                placeholder="Enter your email" type="email"
                style={{ width:'100%', padding:'10px 12px', border:'1.5px solid #e0e0e0', borderRadius:8, fontSize:14, outline:'none', boxSizing:'border-box' }} />
            </div>
            <div style={{ marginBottom:14 }}>
              <label style={{ fontSize:11, fontWeight:700, color:'#888', textTransform:'uppercase', letterSpacing:0.5, display:'block', marginBottom:4 }}>Message</label>
            ...
            <button type="submit" disabled={sending}
              style={{ width:'100%', padding:'12px', background: sending ? '#999' : 'linear-gradient(135deg,#8B0000,#C41E3A)', color:'#fff', border:'none', borderRadius:8, fontSize:14, fontWeight:700, cursor: sending ? 'not-allowed' : 'pointer' }}>
